...
((SELECT id from items WHERE title = 'Keter Chair'), '10/10/2019', '17/10/2019'),
((SELECT id from items WHERE title = 'Keter Chair'), '01/11/2019', '08/11/2019'),
((SELECT id from items WHERE title = 'Keter Chair'), '10/11/2019', '17/11/2019'),
...
((SELECT id from items WHERE title = 'Harry Potter: The Philosophers stone'), '10/11/2019', '17/11/2019'),
...
((SELECT id from items WHERE title = 'Harry Potter: The Chamber of Secrets'), '10/11/2019', '17/11/2019'),
((SELECT id from items WHERE title = 'Harry Potter: The Prisoner of Azkaban'), '01/10/2019', '08/10/2019'),
((SELECT id from items WHERE title = 'Harry Potter: The Prisoner of Azkaban'), '10/10/2019', '17/10/2019'),
((SELECT id from items WHERE title = 'Harry Potter: The Prisoner of Azkaban'), '01/11/2019', '08/11/2019'),
((SELECT id from items WHERE title = 'Harry Potter: The Prisoner of Azkaban'), '10/11/2019', '17/11/2019');

--- id, availability, phone, email,first name, last name
INSERT INTO Borrows (availability, branch, phone, email, first_name, last_name) VALUES
((SELECT max(id) from availabilities), 'Haifa-Main', '054-555666', 'theif@gmail.com', 'Gani', 'Nav'),
((SELECT min(id) from availabilities), 'Haifa-Main', '053-123456', 'yossi@gmail.com', 'Yossi', 'Luchim')