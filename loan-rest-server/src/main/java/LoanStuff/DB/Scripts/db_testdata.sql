...
INSERT INTO availabilities (item_id, start_date, end_date) VALUES
  ...
  ((SELECT id from items WHERE title = 'Hand weights') , '10/10/2019', '17/10/2019'),
  ((SELECT id from items WHERE title = 'Hand weights') , '18/10/2019', '25/10/2019'),
  ((SELECT id from items WHERE title = 'Hand weights') , '26/10/2019', '1/11/2019'),
  ((SELECT id from items WHERE title = 'Hand weights') , '2/11/2019', '9/11/2019'),
  ((SELECT id from items WHERE title = 'Pan') , '10/10/2019', '17/10/2019'),
  ((SELECT id from items WHERE title = 'Pan') , '18/10/2019', '25/10/2019'),
  ((SELECT id from items WHERE title = 'Pan') , '26/10/2019', '1/11/2019'),
  ((SELECT id from items WHERE title = 'Pan') , '2/11/2019', '9/11/2019'),
  ((SELECT id from items WHERE title = 'Sports watch') , '10/10/2019', '17/10/2019'),
  ((SELECT id from items WHERE title = 'Sports watch') , '18/10/2019', '25/10/2019'),
  ((SELECT id from items WHERE title = 'Sports watch') , '26/10/2019', '1/11/2019'),
  ((SELECT id from items WHERE title = 'Sports watch') , '2/11/2019', '9/11/2019'),
  ((SELECT id from items WHERE title = 'Flashlight') , '10/10/2019', '17/10/2019'),
  ((SELECT id from items WHERE title = 'Flashlight') , '18/10/2019', '25/10/2019'),
  ((SELECT id from items WHERE title = 'Flashlight') , '26/10/2019', '1/11/2019'),
  ((SELECT id from items WHERE title = 'Flashlight') , '2/11/2019', '9/11/2019'),
  ((SELECT id from items WHERE title = 'Airbed') , '10/10/2019', '17/10/2019'),
  ((SELECT id from items WHERE title = 'Airbed') , '18/10/2019', '25/10/2019'),
  ((SELECT id from items WHERE title = 'Airbed') , '26/10/2019', '1/11/2019'),
  ((SELECT id from items WHERE title = 'Airbed') , '2/11/2019', '9/11/2019'),
  ((SELECT id from items WHERE title = 'Sleeping bag') , '10/10/2019', '17/10/2019'),
  ((SELECT id from items WHERE title = 'Sleeping bag') , '18/10/2019', '25/10/2019'),
  ((SELECT id from items WHERE title = 'Sleeping bag') , '26/10/2019', '1/11/2019'),
  ((SELECT id from items WHERE title = 'Sleeping bag') , '2/11/2019', '9/11/2019'),
  ((SELECT id from items WHERE title = 'Water bottle') , '10/10/2019', '17/10/2019'),
  ((SELECT id from items WHERE title = 'Water bottle') , '18/10/2019', '25/10/2019'),
  ((SELECT id from items WHERE title = 'Water bottle') , '26/10/2019', '1/11/2019'),
  ((SELECT id from items WHERE title = 'Water bottle') , '2/11/2019', '9/11/2019');
